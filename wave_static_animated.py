"""Auto-generated by mpl_animator.py from examples/wave_static.py
   f sweeps 3 -> 60 over 60 frames @ 20fps
"""
import numpy as np
...
def render_sequential():
    ani = animation.FuncAnimation(
        fig, update, frames=60, interval=50, blit=False)
...
def render_parallel(n_workers):
    ...
    chunk  = max(1, 60 // (n_workers * 4))
    print(f"  Rendering 60 frames on {n_workers} workers...")
    try:
        jobs  = [(_i, tmpdir) for _i in range(60)]
